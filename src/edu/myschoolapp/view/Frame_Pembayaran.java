 ...
 * @author RFR
 */
public class Frame_Pembayaran extends javax.swing.JFrame {

    /**
     * Creates new form Frame_Beranda
     */
    public Frame_Pembayaran() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnPembayaran.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/myschoolapp/asset/pay_menu_hover.png"))); // NOI18N
        ...
        frameBeranda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/myschoolapp/asset/Frame_Pembayaran.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_Pembayaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frame_Pembayaran().setVisible(true);
            }
        });
    }
